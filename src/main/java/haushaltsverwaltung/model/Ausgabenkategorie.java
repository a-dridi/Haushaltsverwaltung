 ...
 */
@Entity
public class Ausgabenkategorie implements Serializable {

    @Id
    @GeneratedValue(strategy=GenerationType.AUTO)
    private int ausgabenkategorieid;
    ...
    public boolean equals(Object obj) {
        ...
        final Ausgabenkategorie other = (Ausgabenkategorie) obj;
    ...
    public int getAusgabenkategorieid() {
        return ausgabenkategorieid;
    }

    public void setAusgabenkategorieid(int ausgabenkategorieid) {
        this.ausgabenkategorieid = ausgabenkategorieid;
    }
